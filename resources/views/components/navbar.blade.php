@guest
<nav class="navbar bg-transparent navbar-expand-lg navbar-dark fw-bold w-100" id="pNavbar">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
          ...
          <li class="nav-item">
            <a class="nav-link mx-2  active" href="{{route('login')}}">{{__('ui.accedi')}}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-2  active" href="{{route('register')}}">{{__('ui.registrati')}}</a>
            <li class="nav-item">
